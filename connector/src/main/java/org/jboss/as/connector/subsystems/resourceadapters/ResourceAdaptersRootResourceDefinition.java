...
public class ResourceAdaptersRootResourceDefinition extends SimpleResourceDefinition {
    ...
    @Override
    public void registerAdditionalPackages(final ManagementResourceRegistration resourceRegistration) {
        resourceRegistration.registerAdditionalPackages(RuntimePackageDependency.required("javax.jms.api"));
    }
}
