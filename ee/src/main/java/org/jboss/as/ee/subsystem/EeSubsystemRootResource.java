...
public class EeSubsystemRootResource extends SimpleResourceDefinition {
    ...
    public static String WILDFLY_NAMING = "org.wildfly.naming";
    public static String JBOSS_INVOCATION = "org.jboss.invocation";
    public static String JSON_API = "javax.json.api";
    public static String JSON_BIND_API = "javax.json.bind.api";
    public static String ECLIPSE_YASSON = "org.eclipse.yasson";
    public static String GLASSFISH_EL = "org.glassfish.javax.el";
    ...
    public void registerAdditionalPackages(ManagementResourceRegistration resourceRegistration) {
        resourceRegistration.registerAdditionalPackages(RuntimePackageDependency.required(WILDFLY_NAMING),
